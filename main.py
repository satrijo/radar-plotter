...
def run_once(data_file, output_root, product_type):
    ...
    write_output_manifest(output_root, {
        ...
        "aggregation_method": product_data.get("aggregation_method"),
        "beam_height_model": product_data.get("beam_height_model", "effective Earth radius (4/3 Earth radius)"),
        "vertical_interpolation": product_data.get("vertical_interpolation"),
        "fallback_fraction": product_data.get("fallback_fraction"),
        "bracketed_fraction": product_data.get("bracketed_fraction"),
